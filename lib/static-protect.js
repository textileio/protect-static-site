...
var GitHubStrategy = require('passport-gitlab2').Strategy;
...
StaticProtect.prototype.init = function(webServer) {
  ...
  passport.use(new GitHubStrategy({
      ...
      callbackURL: this.SITE_URL + "/auth/gitlab/callback"
    },
  ...
  this.app.get('/auth/gitlab/callback',
...
console.log(path.join(this.ROOT_FOLDER, this.DIST_FOLDER))
